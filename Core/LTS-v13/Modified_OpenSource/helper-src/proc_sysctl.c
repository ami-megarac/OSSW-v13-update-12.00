		...
		write_proc_t write_proc, void *PrivateData)
{
	...
	/* Create proc entry */
#if defined(CONFIG_SPX_FEATURE_GLOBAL_KERNEL_VER6)
	procinfo->module_fops->proc_read = (ssize_t (*) (struct file *, char *, size_t, loff_t *)) read_proc;
	procinfo->module_fops->proc_write =(ssize_t (*) (struct file *, const char *, size_t, loff_t *)) write_proc;
#else
	procinfo->module_fops->read = (ssize_t (*) (struct file *, char *, size_t, loff_t *)) read_proc;
	procinfo->module_fops->write =(ssize_t (*) (struct file *, const char *, size_t, loff_t *)) write_proc;
#endif
