...
static void  AST2600_mechanism_disable(uint32_t reg_offset,uint32_t reg_val,uint32_t reg);
static void  AST2600_mechanism_enable(uint32_t reg_offset,uint32_t reg_val,uint32_t reg);
static void disable_scu_uart(int uart_port)
{
	...
	switch(uart_port)
        {
                case UART1:
                        reg_offset = AST2600_SCU_MULTI_FUNC_3;
                        reg_val = AST2600_SCU_MULTI_PIN_UART1;
			AST2600_mechanism_disable(reg_offset,reg_val,reg);
                break;
                case UART2:
                        reg_offset = AST2600_SCU_MULTI_FUNC_3;
                        reg_val = AST2600_SCU_MULTI_PIN_UART2;
			AST2600_mechanism_disable(reg_offset,reg_val,reg);
                break;
                case UART3:
                        reg_offset = AST2600_SCU_MULTI_FUNC_4;
                        reg_val = AST2600_SCU_MULTI_PIN_UART3;
			AST2600_mechanism_disable(reg_offset,reg_val,reg);
			reg = 0;
			
			reg_offset = AST2600_SCU_MULTI_FUNC_6;
                        reg_val =  AST2600_SCU_MULTI_PIN_5_UART3;
                        AST2600_mechanism_disable(reg_offset,reg_val,reg);
			reg = 0;

			reg_offset = AST2600_SCU_MULTI_FUNC_5;
                        reg_val = AST2600_SCU_MULTI_PIN_55_UART3;
                        AST2600_mechanism_disable(reg_offset,reg_val,reg);
                break;
                case UART4:
                        reg_offset = AST2600_SCU_MULTI_FUNC_5;
                        reg_val = AST2600_SCU_MULTI_PIN_UART4;
			AST2600_mechanism_disable(reg_offset,reg_val,reg);
			reg = 0;

			reg_offset = AST2600_SCU_MULTI_FUNC_6;
                        reg_val = AST2600_SCU_MULTI_PIN_5_UART4;
                        AST2600_mechanism_disable(reg_offset,reg_val,reg);
                break;
        }
#else
	...
	switch(uart_port)
        {
                case UART1:
                        reg_offset = AST2600_SCU_MULTI_FUNC_3;
                        reg_val = AST2600_SCU_MULTI_PIN_UART1;
                        AST2600_mechanism_enable(reg_offset,reg_val,reg);
                break;
                case UART2:
                        reg_offset = AST2600_SCU_MULTI_FUNC_3;
                        reg_val = AST2600_SCU_MULTI_PIN_UART2;
