...
#define NETMON_GET_INTERFACE_COUNT 	 _IOC(_IOC_READ, 'N', 0x00, 0x3FFF)
#define NETMON_GET_INTERFACE_LIST	 _IOC(_IOC_READ, 'N', 0x01, 0x3FFF)
#define NETMON_WAIT_FOR_INTERFACE_CHANGE _IOC(_IOC_READ, 'N', 0x02, 0x3FFF)
#define NETMON_WAIT_FOR_LINK_UP 	 _IOC(_IOC_READ, 'N', 0x03, 0x3FFF)
#define NETMON_WAIT_FOR_LINK_DOWN	 _IOC(_IOC_READ, 'N', 0x04, 0x3FFF)
#define NETMON_WAIT_FOR_LINK_CHANGE	 _IOC(_IOC_READ, 'N', 0x05, 0x3FFF)
#else
