...
extern int ast_videocap_create_video_packet(struct ast_videocap_engine_info_t *info, void *ioc);
extern int ast_videocap_create_cursor_packet(struct ast_videocap_engine_info_t *info, void *ioc);
